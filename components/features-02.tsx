      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-16 md:pt-32">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 text-white pb-4">Faster. Smarter.</h2>
                  ...
                  <div className="relative h-full bg-black rounded-[inherit] z-20 overflow-hidden">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                      ...
                      <div className="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                        ...
                        <div>
                          <a
                            className="btn-sm text-white hover:text-white transition duration-150 ease-in-out group [background:linear-gradient(theme(colors.black),_theme(colors.black))_padding-box,_conic-gradient(theme(colors.white),_theme(colors.white/30)_25%,_theme(colors.white/30)_75%,_theme(colors.white)_100%)_border-box] relative before:absolute before:inset-0 before:bg-black/30 before:rounded-full before:pointer-events-none"
                            href="#0"
                          >
