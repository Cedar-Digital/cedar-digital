        ...
        <div className="pt-16 pb-12 md:pt-52 md:pb-20">
          <div>
            ...
            <div className="text-center pb-12 md:pb-20">
              ...
              <h2 className="h2 text-black mb-4">Building the Future Together</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 md:gap-6 lg:gap-12">
              {companies.map((company) => (
                <a
                  ...
                  className={`relative group cursor-pointer overflow-hidden rounded-2xl ${company.bgClass} border border-black p-8 md:p-10 lg:p-12 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:border-black`}
                >
                    ...
                    <div className="grid grid-cols-2 gap-4 md:gap-6">
                      {company.features.map((feature, index) => (
                        <div key={index} className="flex items-center">
                          <svg
                            className="w-4 h-4 md:w-5 md:h-5 fill-black mr-2 flex-shrink-0"
                            viewBox="0 0 16 16"
                            xmlns="http://www.w3.org/2000/svg"
                          >
                  ...
                  {/* Hover overlay */}
                  <div className="absolute inset-0 -z-20 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                </a>
              ))}
            </div>
          </div>
