...
export default function HeroAbout() {
  ...
  <section className="relative">
    ...
    <div className="absolute flex items-center justify-center top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 pointer-events-none -z-10 w-[800px] aspect-square" aria-hidden="true">
      <div className="absolute inset-0 translate-z-0 bg-white rounded-full blur-[120px] opacity-30"></div>
      <div className="absolute w-64 h-64 translate-z-0 bg-white rounded-full blur-[80px] opacity-70"></div>
    </div>
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="pt-32 pb-10 md:pt-40">
        ...
        <div className="text-center">
          <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-white to-white pb-3">The folks behind the name</div>
          <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-6">Transforming Ambition into Impact</h1>
          {/* Rings illustration */}
